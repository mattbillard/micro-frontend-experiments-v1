  ...
  return (
    <div id="title-bar">
      ...
      <div id="buttons-wrapper">
        <div className="button" title="Minimize Window" id="minimize-button" onClick={() => window.fin.me.minimize()}></div>
        <div className="button" title="Maximize Window" id="expand-button" onClick={() => maxOrRestore()}></div>
        <div className="button" title="Close Window" id="close-button" onClick={() => window.fin.me.close()}></div>
      </div>
    </div>
  )
}
